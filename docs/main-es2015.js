...
module.exports = "<p>articles works!</p>\n"
...
module.exports = "\n<div class='my-2'>\n\t<section>\n\t\t<div>\n\t\t\t<h3>Contact</h3>\n\t\t</div>\n\t</section>\n</div>\n\n<div class=''>\n\t<section>\n\t\t<div>\n      <p>ご連絡は以下のフォームから頂けますと幸いです。</p>\n      <!-- google form -->\n      <iframe src=\"https://docs.google.com/forms/d/e/1FAIpQLSeopYPOufAoAhuU06_IS4ACnaS9S0xdVFJHF3NXoF2j4qtRYg/viewform?embedded=true\" width=\"640\" height=\"760\" frameborder=\"0\" marginheight=\"0\" marginwidth=\"0\">読み込んでいます…</iframe>\n\t\t</div>\n\t</section>\n</div>\n\n"
...
module.exports = "<footer class='bg-light mb-0'>\n\t<ul class='nav justify-content-center'>\n    <li class=\"nav-item\">\n      <a routerLink='/' class='nav-link'>Home</a>\n    </li>\n    <li class=\"nav-item\">\n      <a routerLink='/profile' class=\"nav-link\">Profile</a>\n    </li>\n    <li class=\"nav-item\">\n      <a routerLink='/skills' class=\"nav-link\">Skills</a>\n    </li>\n    <li class=\"nav-item\">\n      <a routerLink='/works' class=\"nav-link\">Works</a>\n    </li>\n    <li class=\"nav-item\">\n      <a routerLink='/articles' class=\"nav-link\">Articles</a>\n    </li>\n    <li class=\"nav-item\">\n      <a routerLink='/contact' class=\"nav-link\">Contanct</a>\n    </li>   \n\n\t</ul>\n\t<div class='container text-center'>\n\t\t<p class='mb-0'>\n\t\t\t<small>Copyright &copy;2019 みたいなのを書くところ</small>\n\t\t</p>\n\t</div>\n</footer>"
...
module.exports = "\n<div class='my-2'>\n    <section>\n      <div>\n        <h3>Profile</h3>\n      </div>\n    </section>\n  </div>\n  \n  <div>\n    <section>\n      <div>\n        <p>はじめまして、1990年生まれのエンジニアです。</p>\n        <p>大学は文系学部を出ました。</p>\n        <p>新卒では地方の広告代理店に入社し、マーケティングや、ペーパーメディアのバイイングなどをしました。</p>\n        <p>その後、プログラミングなど全くできない状態ながら、ウェブサービスを作ろう！と思い、退社し独学でプログラミングの勉強をしてきました。</p>\n        <p>2年の独学+開発ののちに、プロトタイプを作りベンチャーキャピタルからの出資を目指しましたが叶わず、お金も尽きたのでまた就職することにしました。</p>\n        <p>これはそのために作ったポートフォリオサイトです。</p>\n      </div>\n    </section>\n  </div>"
...
module.exports = "\n<div class='my-2'>\n\t<section>\n\t\t<div>\n\t\t\t<h3>Skills</h3>\n\t\t</div>\n\t</section>\n</div>\n\n<div>\n\t<!-- プログラミング言語 -->\n\t<div class='card mb-1'>\n\t\t<div class='card-body'>   \n\t\t\t<h5 class='card-title'>プログラミング言語</h5>\n\t\t\t<span *ngFor='let skill of programmingLanguages' class='badge badge-secondary mr-2'>{{ skill }}</span>\n\t\t</div>\n\t</div>\n\n\t<!-- マークアップ言語 -->\n\t<div class='card mb-1'>\n\t\t<div class='card-body'>   \n\t\t\t<h5 class='card-title'>マークアップ言語</h5>\n\t\t\t<span *ngFor='let skill of markupLanguages' class='badge badge-secondary mr-2'>{{ skill }}</span>\n\t\t</div>\n\t</div>\n\n\t<!-- フロントエンド -->\n\t<div class='card mb-1'>\n\t\t<div class='card-body'>   \n\t\t\t<h5 class='card-title'>フロントエンド</h5>\n\t\t\t<span *ngFor='let skill of frontendSkills' class='badge badge-secondary mr-2'>{{ skill }}</span>\n\t\t</div>\n\t</div>\n\n\t<!-- python -->\n\t<div class='card mb-1'>\n\t\t<div class='card-body'>   \n\t\t\t<h5 class='card-title'>python</h5>\n\t\t\t\t<span>アプリケーション</span><br>\n\t\t\t\t<span *ngFor='let skill of pythonSkills.webApps' class='badge badge-secondary mr-2'>{{ skill }}</span>\n\t\t\t\t<hr>\n\t\t\t\t<span>スクレイピング</span><br>\n\t\t\t\t<span *ngFor='let skill of pythonSkills.scraping' class='badge badge-secondary mr-2'>{{ skill }}</span>\n\t\t\t\t<hr>        \n\t\t\t\t<span>スタックキュー</span><br>\n\t\t\t\t<span *ngFor='let skill of pythonSkills.stackQueue' class='badge badge-secondary mr-2'>{{ skill }}</span>\n\t\t\t\t<hr>\n\t\t\t\t<span>機械学習</span><br>\n\t\t\t\t<span *ngFor='let skill of pythonSkills.machineLearningPackages' class='badge badge-secondary mr-2'>{{ skill }}</span>\n\t\t\t\t<hr>        \n\t\t</div>\n\t</div>\n\n\t<!-- DB -->\n\t<div class='card mb-1'>\n\t\t<div class='card-body'>   \n\t\t\t<h5 class='card-title'>DB</h5>\n\t\t\t<span *ngFor='let skill of DB' class='badge badge-secondary mr-2'>{{ skill }}</span>\n\t\t</div>\n\t</div>\n\n\t<!-- クラウド -->\n\t<div class='card mb-1'>\n\t\t<div class='card-body'>   \n\t\t\t<h5 class='card-title'>クラウドサービス</h5>\n\t\t\t<span *ngFor='let skill of cloudService' class='badge badge-secondary mr-2'>{{ skill }}</span>\n\t\t</div>\n\t</div>  \n\n</div>"
...
module.exports = "<p>works works!</p>\n"
...
/* harmony import */ var _works_works_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./works/works.component */ "./src/app/works/works.component.ts");
/* harmony import */ var _articles_articles_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./articles/articles.component */ "./src/app/articles/articles.component.ts");
...
const routes = [
    ...
    {
        path: 'works',
        component: _works_works_component__WEBPACK_IMPORTED_MODULE_6__["WorksComponent"]
    },
    {
        path: 'articles',
        component: _articles_articles_component__WEBPACK_IMPORTED_MODULE_7__["ArticlesComponent"]
    },
    {
        path: 'contact',
...
let SkillsComponent = class SkillsComponent {
    constructor() {
        this.programmingLanguages = MY_SKILLS.programmingLanguages;
        this.markupLanguages = MY_SKILLS.markupLanguages;
        this.frontendSkills = MY_SKILLS.frontendSkills;
        this.pythonSkills = MY_SKILLS.python_skills;
        this.DB = MY_SKILLS.DB;
        this.cloudService = MY_SKILLS.cloudService;
    }
    ngOnInit() {
    }
};
...
module.exports = __webpack_require__(/*! /Users/hiroishizai/Dropbox/angular-projects/my_portfolio_site/src/main.ts */"./src/main.ts");
